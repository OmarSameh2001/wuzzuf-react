...
const Meeting = ({ phase, clickedColumn, applicationData }) => {
    ...
    if (applicationData) {
      ...
      const getPhaseData = () => {
        switch (phase) {
          ...
          case "Hr Interview":
            return {
              link: applicationData.hr_link,
              time: applicationData.hr_time,
            };
          case "Offer":
            return {
  ...
  if (!applicationData) {
    return (
      <div
        className={`meeting-empty-state ${
          isLight ? "light-mode" : "dark-mode"
        }`}
      >
        <div className="meeting-animations">
          <div className="meeting-lottie-container">
            <Lottie animationData={waitingOptions} loop autoplay style={{height:120 , width:120}}/>
          </div>
          <div className="meeting-lottie-container person-animation">
            <Lottie animationData={waitingPersonOptions} loop autoplay style={{height:120 , width:120}}/>
          </div>
        </div>
  ...
  const getStatusBackground = (status) => {
    switch (status) {
      ...
      case "failed":
        return {
          backgroundImage: `radial-gradient(circle at 90% 10%, ${
            isLightMode ? "rgba(239, 68, 68, 0.15)" : "rgba(239, 68, 68, 0.25)"
          } 0%, transparent 70%)`,
        };
      case "active":
        return {
      ...
      case "waiting":
        return {
          backgroundImage: `radial-gradient(circle at 90% 10%, ${
            isLightMode ? "rgba(144, 27, 38, 0.15)" : "rgba(215, 50, 62, 0.25)"
          } 0%, transparent 70%)`,
        };
      default:
        return {};
      ...
      <Paper elevation={3} className="meeting-paper">
        ...
        <div className="meeting-content">
          {appStatus === clickedColumn && applicationData.fail ? (
            <div
              className="meeting-status failed"
              style={getStatusBackground("failed")}
            >
              <div className="meeting-animations">
                <div className="meeting-lottie-container">
                  <Lottie animationData={failureAnimation} loop autoplay style={{ height: 120, width: 120 }} />
                </div>
                <div className="meeting-lottie-container person-animation">
                  <Lottie
                    animationData={failurePersonAnimation}
              ...
              <div className="meeting-status-message">
                ...
                <Typography variant="body1">
                  Don't give up! Every setback is an opportunity to learn and
                  grow. Keep improving your skills and try again.
                </Typography>
              </div>
            </div>
            ...
            <>
              {phaseLink ? (
                <div
                  ...
                  style={getStatusBackground("active")}
                >
                  <div className="meeting-animations">
                    <div className="meeting-lottie-container">
                      <Lottie
                    ...
                    {appStatus != 2 ? (
                      <>
                        ...
                        <Typography variant="body1">
                          ...
                          <span className="meeting-highlight">
                      ...
                      <>
                        <Typography variant="h5">Technical Assessment Assigned</Typography>
                ...
                <div
                  className="meeting-status pending"
                  style={getStatusBackground("pending")}
                >
                  <div className="meeting-animations">
                    <div className="meeting-lottie-container">
                      <Lottie
                  ...
                  <div className="meeting-status-message">
                    ...
                    <Typography variant="body1">
                      You qualified to this phase but the meeting isn't assigned
                      yet. We'll notify you once it's scheduled.
                    </Typography>
                  </div>
                </div>
              )}

              {phaseLink && appStatus != 2 && (
                <Box className="meeting-action">
                  <Button
                    variant="contained"
                    color="primary"
                ...
                <div className="meeting-calendar-section">
                  <div className="meeting-calendar-header">
                    <Typography variant="h6" className="meeting-calendar-title">
                      <FaCalendarAlt className="meeting-calendar-icon" />{" "}
                      Meeting Schedule
                    </Typography>
                  ...
                  <div className="meeting-calendar-wrapper">
                    <Calendar
                      ...
                      components={{
                        event: (props) => (
                          <Tooltip
                            title={`${props.event.title} - ${format(
                              props.event.start,
                              "h:mm a"
                            )}`}
                          >
                            <div className="meeting-event-content">
                              ...
                              <span className="meeting-event-time">
                  ...
                  <div className="meeting-time-details">
                    <div className="meeting-time-item">
                      ...
                      <span className="meeting-time-value">
            ...
            <div
              ...
              style={getStatusBackground("success")}
            >
              <div className="meeting-animations">
                <div className="meeting-lottie-container">
                  <Lottie animationData={successAnimation} loop autoplay style={{ height: 120, width: 120 }} />
                </div>
                <div className="meeting-lottie-container person-animation">
                  <Lottie
                    animationData={successPersonAnimation}
              ...
              <div className="meeting-status-message">
                ...
                <Typography variant="body1">
                  You have successfully passed this phase. Your hard work and
            ...
            <div
              ...
              style={getStatusBackground("waiting")}
            >
              <div className="meeting-animations">
                <div className="meeting-lottie-container">
                  <Lottie animationData={waitingAnimation} loop autoplay style={{ height: 120, width: 120 }} />
                </div>
                <div className="meeting-lottie-container person-animation">
              ...
              <div className="meeting-status-message">
                ...
                <Typography variant="body1">
                  You didn't proceed to this phase yet. Complete previous phases
                  to continue your application journey.
                </Typography>
              </div>
            </div>
          )}
